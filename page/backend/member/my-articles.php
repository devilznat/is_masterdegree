...
// echo $_SESSION["role_ID"];
  ...
  if(!isset($_SESSION['user_ID']))
  {
	...
	if($_GET["article_ID"]!="") {
		...
		$SQL = "delete from lawArticle where article_ID='".$_GET["article_ID"]."' and user_ID='".$_SESSION["user_ID"]."'";
...
<?php  
		...
		$SQL = "select * from lawArticle where user_ID='".$_SESSION['user_ID']."'  order by article_ID desc $limit";
		$rst = mysqli_query($link, $SQL) or die(mysqli_error($link).$SQL);
...
?>
              ...
              <tr>
                ...
                <td> 
                  ...
                  <div class="btn-group" role="group" aria-label="...">
                  <a type="button" class="btn btn-warning" href="add-exp.php?article_ID=<?php   print $tmp["article_ID"]?>">แก้ไข</a> 
                  <a type="button" class="btn btn-danger"onclick="return remove_dw();" href="my-articles.php?article_ID=<?php   print $tmp["article_ID"]?>&filename=<?php   print $tmp["lawArticlePic"]?>">ลบ</a>
