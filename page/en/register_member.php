...
<head>
	<title>Justroolaws - Laws Consulting Website| Member Regsitration Page</title>
	...
	<div class="wrapper">
		...
		<div class="container content ">
			...
			<div class="alert alert-success fade in hidden" name="showalert" id="showalert">
									<strong>Register Member Success!</strong> Your Information sending to us already.
			</div>
			...
			<div class="row job-viewbox">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<h3><strong>Register Member</strong> </h3>
						<HR class="hr-title">
				...
				<div class="row">
					...
					<input type="text" name="type" id="type" value="register-member" hidden>
					
					<input type="text" name="typerole" id="typerole" value="1" hidden>		
				...
				$.ajax({
				    ...
				    success:  function(data){
				        ...
				        var data = "?firstname="+sendfirstname+"&lastname="+sendlastname+"&username="+sendusername+"&password="+sendpassword+"&email="+sendemail+"&phone="+sendphone+"&typerole="+sendtyperole;
		       		 	...
		       		 	window.location.assign("http://justroolaws.com/page/email-templates/sendmail-register-member.php"+data);
